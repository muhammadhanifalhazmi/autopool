...
const ALL_CARS = [
  ...
  { id: 7, name: "Honda Civic Turbo", price: "Rp 385.000.000", year: 2023, mileage: "5.000 km", fuel: "Bensin", trans: "CVT", color: "#c0392b", brand: "Honda", engine: "1.5L VTEC Turbo", color_name: "Merah", location: "Semarang", desc: "Honda Civic Turbo generasi terbaru, kondisi seperti baru. Desain sporty dengan interior modern. Honda Sensing aktif untuk keselamatan berkendara." },
  { id: 8, name: "Audi A4 2.0 TFSI", price: "Rp 675.000.000", year: 2022, mileage: "14.000 km", fuel: "Bensin", trans: "Automatic", color: "#1a1a1a", brand: "Audi", engine: "2.0L TFSI", color_name: "Hitam", location: "Jakarta Barat", desc: "Audi A4 S-Line package, kondisi sangat terawat. Virtual cockpit, MMI navigation, dan matrix LED headlights. Servis rutin di dealer resmi." },
];
